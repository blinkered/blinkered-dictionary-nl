# Blinkered dictionary: Dutch

The Dutch word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Dutch.

**159,228 of 322,146 candidates proved — 49.4%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Dutch, and why those
...
Candidates come from Blinkered's Dutch list, which lives in
[`blinkered-attestation/candidates/nl`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/nl).
